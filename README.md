...
# How to determine process name? (Manually)
...
Alternatively, in version 0.0.2; a process list was introduced to show all running processes in a list that can be called.
